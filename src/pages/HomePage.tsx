...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      ...
      <section className="py-16 md:py-24 bg-gray-50 dark:bg-black  items-center">
            ...
            {[
              {
                ...
                description:
                  "Building responsive, performant, and accessible websites and web applications.",
                icon: "🌐",
              },
              {
              ...
              },
              {
                title: "UI/UX Design",
                description:
                  "Designing intuitive and engaging user experiences that prioritize usability.",
                icon: "🎨",
              },
              {
              ...
              },
              {
                ...
                description:
                  "Transforming complex data into insightful and interactive visualizations.",
                icon: "📊",
              },
              {
                title: "Technical Consultation",
                description:
                  "Providing expert advice on technology choices and implementation strategies.",
                icon: "💬",
              },
            ].map((service, index) => (
              <div
                key={index}
                className="bg-white dark:bg-black p-8 rounded-xl shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-1"
              >
              ...
              {[
                {
                  title: "Discovery",
                  description:
                    "Understanding your goals, requirements, and constraints through in-depth consultation.",
                },
                {
                  title: "Strategy & Planning",
                  description:
                    "Developing a comprehensive plan with timeline, technical approach, and success metrics.",
                },
                {
                  title: "Design & Prototyping",
                  description:
                    "Creating wireframes and interactive prototypes to visualize the solution before development.",
                },
                {
                  title: "Development",
                  description:
                    "Building the solution with clean, maintainable code and regular progress updates.",
                },
                {
                  title: "Testing & Refinement",
                  description:
                    "Rigorous testing across devices and implementing refinements based on feedback.",
                },
                {
                  title: "Deployment & Support",
                  description:
                    "Launching the solution and providing ongoing support and maintenance as needed.",
                },
              ].map((step, index) => (
                <div
                  key={index}
